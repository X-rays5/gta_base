...
namespace base::render {
  class Renderer {
    ...
    public:
      ...
      device_ptr_t GetDevice() const { return device_; }
      device_context_ptr_t GetDeviceCtx() const { return device_ctx_; }
      swapchain_ptr_t GetSwapchain() const { return swap_chain_; }
