...
namespace rage::util {
  ...
  rage::scrVector GetObjectiveLocation() {
    ...
    if ((res = GetBlipLocation((int) BlipIcons::Circle, (int) BlipColors::YellowMission)))
      return res;
    if ((res = GetBlipLocation((int) BlipIcons::Circle, (int) BlipColors::YellowMission2)))
      return res;
    if ((res = GetBlipLocation((int) BlipIcons::Circle, (int) BlipColors::Mission)))
      return res;
    if ((res = GetBlipLocation((int) BlipIcons::RaceFinish, (int) BlipColors::None)))
      return res;
    if ((res = GetBlipLocation((int) BlipIcons::Circle, (int) BlipColors::Green)))
      return res;
    if ((res = GetBlipLocation((int) BlipIcons::Circle, (int) BlipColors::Blue)))
      return res;
    if ((res = GetBlipLocation((int) BlipIcons::CrateDrop)))
      return res;

    static const int blips[] = {1, 57, 128, 129, 130, 143, 144, 145, 146, 271, 286, 287, 288};
    for (const auto& blip: blips) {
      if ((res = GetBlipLocation(blip, 5)))
        return res;
    }
