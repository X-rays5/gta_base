...
namespace gta_base::ui::draw::components {
  class BoolOption final : public BaseOption {
  public:
    BoolOption(const std::string& name, const std::string& description, bool& toggle, flags::OptionFlags flags = flags::OptionFlags::kHotkeyAble | flags::OptionFlags::kSaveAble) : toggle_(toggle), BaseOption(name, description, nullptr, flags) {}
