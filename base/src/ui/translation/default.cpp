...
namespace gta_base::ui {
   const robin_hood::unordered_map<std::string, std::string> translation::default_translation = {
    ...
    ADD_TRANSLATION("option/hotkey_save_on_exit", "Save Hotkeys on Exit"),
    ADD_TRANSLATION("option/hotkey_save_on_change", "Save Hotkeys on Change"),
    ADD_TRANSLATION("option/no_hotkeys", "No Hotkeys"),
    ADD_TRANSLATION("option/active_hotkey_profile", "Active Hotkey Profile"),
    ADD_TRANSLATION("option/refresh_hotkey_profile_list", "Refresh Hotkey Profile List"),
