...
namespace gta_base::ui {
  ...
  ADD_TRANSLATION("tab/title/delete_translation", "Delete"),
  ADD_TRANSLATION("tab/title/hotkeys", "Hotkeys"),
  ADD_TRANSLATION("tab/title/hotkey_profiles", "Profiles"),
  ...
  ADD_TRANSLATION("label/hotkey_list", "Hotkeys"),
  ADD_TRANSLATION("label/hotkey_profile_list", "Profiles"),
  ...
  ADD_TRANSLATION("option/create_new_translation", "Generate new translation"),
  ADD_TRANSLATION("option/active_translation", "Active:"),
  ADD_TRANSLATION("option/refresh_translation_list", "Refresh"),
  ADD_TRANSLATION("option/translation_set_active", "Set active"),
  ADD_TRANSLATION("option/translation_delete", "Delete"),
  ADD_TRANSLATION("option/translation_cancel_delete", "Cancel"),
  ADD_TRANSLATION("option/no_translations", "No Translations"),
  ADD_TRANSLATION("option/hotkey_save_on_exit", "Save on Exit"),
  ADD_TRANSLATION("option/hotkey_save_on_change", "Save on Change"),
  ADD_TRANSLATION("option/no_hotkeys", "No Hotkeys"),
  ADD_TRANSLATION("option/active_hotkey_profile", "Active:"),
  ADD_TRANSLATION("option/refresh_hotkey_profile_list", "Refresh"),
  ADD_TRANSLATION("option/hotkey_save_current_as", "Save Current as"),
  ADD_TRANSLATION("option/no_hotkey_profiles", "No Hotkey Profiles"),
  ...
  ADD_TRANSLATION("hint/keyboard_input", "CTRL+ENTER to input value"),
  ADD_TRANSLATION("hint/set_hotkey", "F1 to set hotkey"),
  ADD_TRANSLATION("hint/hotkey_already_set", "Hotkey:"),
  ADD_TRANSLATION("hint/press_to_save", "Press F11 to save"),
  ADD_TRANSLATION("txt/deleted_translation", "Deleted"),
  };
}