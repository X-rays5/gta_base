...
#pragma once
#ifndef GTA_BASE_SPOOF_HPP
#define GTA_BASE_SPOOF_HPP
#include <type_traits>
...
namespace detail
{
  ...
  struct argument_remapper {
    ...
    static Ret do_call(const void* shell, void* shell_param, First first, Second second, Third third, Fourth fourth, Pack... pack) {
  ...
  struct argument_remapper<Argc, std::enable_if_t<Argc <= 4>> {
    ...
    static Ret do_call(const void* shell, void* shell_param, First first = First{}, Second second = Second{}, Third third = Third{}, Fourth fourth = Fourth{}) {
...
template <typename Ret, typename... Args>
static inline Ret spoof_call(const void* trampoline, Ret(*fn)(Args...), Args... args) {
  struct shell_params {
