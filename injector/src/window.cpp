  ...
  void SetupImGuiStyle()
{
	...
	style.Colors[ImGuiCol_TabSelected] = ImVec4(0.2509804f, 0.2509804f, 0.2509804f, 1.0f);
	style.Colors[ImGuiCol_TabDimmed] = ImVec4(0.16862746f, 0.16862746f, 0.16862746f, 1.0f);
	style.Colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.21568628f, 0.21568628f, 0.21568628f, 1.0f);
